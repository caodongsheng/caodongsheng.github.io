<template>
  <div class="header-wrap" style="height: 100%;background: #fff;">
    ...
    <div class="zmbox"></div>
    <popup-picker title="您与受助人的关系" :data="list" v-model="relation" show-name  value-text-align="right"></popup-picker>
    <div class="zmbox"></div>
    <x-input
      title="您的姓名"
      placeholder="请填写真实姓名"
