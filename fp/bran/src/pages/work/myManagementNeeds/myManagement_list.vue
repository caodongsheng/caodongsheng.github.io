  ...
  <div>
    ...
    <div class="box-withheader">
      <div class="list-topoperate display-flex f-16 bg-ffffff color-999">
        ...
        <selectRegion :datas='selects2' @getdatas="getdatas" style="width:25%"></selectRegion>
      </div>
      <!--总计-->
                ...
                <div class="dis-block linkonly" @click=getHelpType(item.demand_type,item.id)>
                  <div class="flex-tab">
                    <div class="flex-tab-cell tab-left">
                      <img v-lazy="getmidpic(item.img_url)||'../../static/appimg/rec/slh3.png'" width="80" height="80">
                    </div>
 ...
 import { getMidPic } from "@/util/getMid";
  ...
  export default {
    ...
    return getMidPic(imgurl)
      ...
      getdatas (datas) {
        if(datas[1].regionNameIdname==JSON.parse(this.G("city")).provinceName){
          return false 
        }
        ...
        console.log("几种值"+datas[1].category_name)
        // if (datas[1].category_name === '贵州省' || datas[1].category_name === '江西省') {
        // if (datas[1].category_name === '贵州省' || datas[1].category_name === '江西省') {
