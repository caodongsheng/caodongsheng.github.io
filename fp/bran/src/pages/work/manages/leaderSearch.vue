    ...
    <div>
        ...
        <div class="bg-f6f5f6">
            ...
            <div class="search-white flex-tab">
                ...
                <div>搜索</div> -->
                <div class="searchBox">
                    <x-input title="" placeholder="搜索" v-model.trim="input" @on-enter="getData" @on-click-clear-icon="getDatas">
                        <i slot="label" class="fa fa-search" aria-hidden="true"></i>
                    </x-input>
                </div>
                            ...
                            <ul>
                                <li v-for="(item,index) in managerList" :key="index">
                                    ...
                                    <div class="regionName">
                                        <p v-for="n in item.region" :key="n.region_name">{{n.region_name}}</p>
                                    </div>
