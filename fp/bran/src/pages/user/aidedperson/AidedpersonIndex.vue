<template>
  <div>
    ...
    <template v-else-if="pagemodel && isFromMy == 'all'">
      <aidpersonpagemodelManage
        :on-choose='aidperson.onChoose'
        :person-data='personData'
        :close="close"
...
<script>
  ...
  import aidpersonpagemodelManage from "./aidpersonPgemodelManage"
  ...
  export default {
    ...
    created() {
      // 在页面挂载前就发起请求
      this.isFromMy = this.$route.query.aidedpersonType
