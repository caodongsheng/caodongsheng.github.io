<template>
  <div v-if="demandDetail.demand_status!==undefined">
    ...
    <div class="box-withbar over-auto bg-f6f5f6" :style="getBottom">
      ...
      <div v-if="demandDetail.demand_status!==1&&demandDetail.demand_status!==2" class="help-progess bg-ffffff mb-12" style="padding: 15px;">
        <div class="clearfix help-pro-head f-14">
          ...
          <span class="f_r color-999">进度：<em class="color-orange">{{demandDetail.speed}}%</em></span>
        </div>
        <range class="range-spe" :value='demandDetail.speed' disabled :rangeBarHeight="4"></range>
    ...
    <!--底部操作-->
    <button-actions :demandDetail="demandDetail" v-if="getDetailBtn()" ></button-actions>
