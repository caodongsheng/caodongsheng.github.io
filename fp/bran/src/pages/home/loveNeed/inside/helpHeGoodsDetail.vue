      ...
      <div class="info-base bg-ffffff mb-12">
        <div class="flex-tab">
          <div class="flex-tab-cell tab-left linkonly">
            <img v-lazy="getmidpic(aidedObj.image)" width="80" height="80">
          </div>
        ...
        <div class="recordshow">
          ...
          <swiper :options="swiperOption" ref="mySwiper" class="scrollswiper">
            <swiper-slide v-for="(item1,index1) in aidedObj.img" :key="index1">
              ...
              <div class="previewer-demo-img" style="padding-top:100%" @click="show(index1)" :style="{backgroundImage:'url('+getmidpic(item1)+')',backgroundSize:'cover',backgroundPosition:'center'}">
              </div>
            </swiper-slide>
          </swiper>
          <div v-transfer-dom>
