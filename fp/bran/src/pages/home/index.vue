  ...
  <div class="index-wrap">
    ...
    <header style="height:30px;">
      <div class="dis-flex" style="align-items: center;">
        ...
        <div  class="flex-city flex-left color-999">
          <router-link to @click.native="toapp" class="top-msgtip dis-block" >
              <!-- <i class="home"></i> -->
            <!--<i class="fa fa-bell-o" aria-hidden="true"></i>-->
            <!-- <em class="color-999 f-11">回主页</em> -->
            <span class="currentLocation">{{city.name}}</span>
          </router-link>
        </div>
        <!--  -->
...
<style lang="less" scoped>
  ...
  .index-wrap header .currentLocation {
    position:relative;
    display: flex;
    align-items:center;
    margin:0 23px 0 5px;
  ...
  .index-wrap header .currentLocation:after{
    position:absolute;
    right: -12px;
    top: 38%;
    width: 0;
