  ...
  export default {
    ...
    methods: {
      ...
      getProvince(callback) {
        ...
        // this.$store.dispatch("getRegionListById", {
        //   id: "520000000000", type: 1, callackfun: function () {
        ...
        // });
          ...
          this.info = [{id:this.city.provinceArea,regionName:this.city.provinceName}]
          callback();
      },
...
<style  scoped>
  ...
  .address3>>>.vux-cell-placeholder{font-size: 14px;}
