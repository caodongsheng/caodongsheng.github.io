...
<div class="phtp">   
  <img src="./3.png" :style="{backgroundImage:'url('+img+')',backgroundRepeat: 'no-repeat',backgroundSize:'cover',backgroundPosition:'center'}"
   v-if="img !== undefined && img !== '' && img!==null" @error="setErrorImg" class="img1">
  <img src="./2.png" class="img2" alt="">
</div>
...
<style scoped>
 ...
 .phtp{
  width: 35px; height: 40px; position: relative; margin: 0 auto; overflow: hidden;
}
.phtp img.img1{
