<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column width="280" fixed="right" align="center" label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="primary"  @click="operationAudit(scope.row.id,0,'')">审核通过</el-button>
          <el-button size="mini" type="primary"  @click="why(scope.row)">审核不通过</el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getListCha() {
        ...
        this.$http.post('hts/management/finallyReviewDemand', this.showList).then(res => {
          this.list = res.vos
