    ...
    <div class="box-withheader">
      <scrolltemplate
        ...
        <div class="banner">
          ...
          <!--   <p class="num"><img
              src="../../common/images/user-icon-redu.png"
              alt=""
            >{{item.help_money * 2}}</p> -->
...
<script>
  ...
  export default {
    components: {XHeader, Scroller, headerBackTitleShare, avatar, avatarsix, scrolltemplate},
    data () {
      return {
        vos: [],
        page: 1,
...
//        this.vosOther = [{ "help_money": 1100,"nick_name":"单纯的","user_id": "13" },{ "help_money": 900,"nick_name":"ddds", "user_id": "12"},{ "help_money": 700,"nick_name":"ddds","user_id": "11"},{"help_money": 200,"nick_name":"是ds","user_id": "14"}]
    ...
    this.sharevos.link = this.WinXinHost + '#' + location.href.split('#')[1]
        ...
        this.sharevos.imgUrl =  "../../../static/appimg/share_icon.png"
