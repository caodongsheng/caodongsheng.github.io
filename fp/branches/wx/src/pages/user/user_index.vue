<template>
  <div  class="animated fadeInRight h-full">
    <x-header :left-options="{showBack: false}"><router-link to="setting" slot="left">
    ...
    <div class="bg-f6f5f6 box-withbar over-auto">
      ...
      <div class="user-opelist mt-15 mb-15">
        <group>
          <cell class="bg-ffffff" title="帮扶记录" is-link :link="capital">
        ...
        <group class="mt-15">
          ...
          <cell class="bg-ffffff" title="受助人管理" is-link :link="aidedperson">
            <img slot="icon" width="20" style="display:block;margin-right:10px;"
        ...
        <group class="mt-15">
          <cell class="bg-ffffff" title="我的邀请" is-link :link="inviteMine" v-if="!this.isWeixinCient()">
            <img slot="icon" width="20" style="display:block;margin-right:10px;"
          ...
          <cell class="bg-ffffff" title="我的关注" is-link link="myfollow">
            <img slot="icon" width="20" style="display:block;margin-right:10px;"
