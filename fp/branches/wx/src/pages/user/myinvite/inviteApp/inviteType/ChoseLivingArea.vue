  ...
  <div class="Myinvitation" @click="CloseSelect">
    ...
    <div class="confirmSubmit" v-show="ifsubmit">
      <div class="confirmSubmitDiv"> 
        ...
        <p class="c_cont">是否确认生成所在地域为<span>“{{confirmArea}}”</span>的邀请二维码信息</p>
...
export default {
  ...
  data () {
    return {
      msg: '选择所在地域',
      MsgArr: ['请选择您所在省份','请选择您所在城市','请选择您所在县城','请选择您所在乡镇','请选择您所在村落'],
      AreaBox:[0,1,2,3,4],
      AreaDataArr: ['','','','',''],
  ...
  methods:{
    ...
    ChangeMsg: function (n,v){
      ...
      let msgArray=['请选择您所在省份','请选择您所在城市','请选择您所在县城','请选择您所在乡镇','请选择您所在村落'];
      for(let i=n+1;i<=4;i++){
