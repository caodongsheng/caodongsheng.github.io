      ...
      <div class="info-base bg-ffffff mb-12" @click="goToDetail()">
        <div class="flex-tab">
          <div class="flex-tab-cell tab-left linkonly">
            <img :src="aidedPersonObj.image" width="80" height="80">
          </div>
        ...
        <div class="detailshow">
          ...
          <swiper :options="swiperOption" ref="mySwiper" class="scrollswiper">
            <swiper-slide v-for="(item1,index1) in aidedPersonObj.img" :key="index1">
              ...
              <div class="previewer-demo-img" v-lazy:background-image="item1" style="padding-top:100%" @click="show(index1)" :style="{backgroundSize:'cover',backgroundPosition:'center'}">
              </div>
            </swiper-slide>
          </swiper>
          <div v-transfer-dom>
