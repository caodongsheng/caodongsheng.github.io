          ...
          <div class="imguploads clearfix ">
            ...
            <div class="imguploads-item" v-if="isAddImgShow">
              <div class="item-wrap addimg" @click="showMenu">
                <p>
                  <input type="file"  ref="file" @change="add_img" accept="image/*" id="fileinput" style="height: 100%;width: 100%;position: absolute;top:0;left: 0;opacity: 0;-ms-filter: 'alpha(opacity=0)'">
