                ...
                <div class="flex-tab">
                  <div class="backBtn flex-tab-cell tab-left">
                    ...
                    <div class="flex-tab-cell  tab-mid" style="height:30px;">
                        <x-input title="" placeholder= "搜索" @on-enter="Subm()" v-model="searchtxt" @on-focus="handleinput()" ref="searchinput" style="height: 30px;top: 3px;" >
              ...
              <div class="list-content" @click="todetail(item)">
                ...
                <div class="flex-tab">
                  ...
                  <div class="flex-tab-cell tab-right">
                    ...
                    <Progresss :proge="Number(item.moneycount/item.target_amount*100).toFixed()" style="padding-top:15px;" v-if="Number(Number(item.demand_type))!==1"></Progresss>
...
<script>
import {XInput, Tab, Badge, Range, CheckIcon,TabItem,Search,Confirm,XHeader,TransferDomDirective as TransferDom} from 'vux'
...
export default {
    ...
    components: {XInput, Tab, TabItem,Confirm,XHeader,Search,Badge, Range, CheckIcon,Avatar,Progresss},
    data() {
        return {
            searchtxt: '',
            historyxs: true,
...
.hotSearchCon *{box-sizing: border-box;padding:10px;}
