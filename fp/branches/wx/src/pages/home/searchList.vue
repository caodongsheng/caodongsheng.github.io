      ...
      <header>
        <div class="flex-tab">
          ...
          <div class="flex-tab-cell  tab-mid">
            <x-input title="" placeholder="搜索"  @on-enter="Submt()" v-model="input" clearable>
              ...
              <div class="list-content" @click="todetail(item)">
                ...
                <div class="flex-tab">
                  ...
                  <div class="flex-tab-cell tab-right">
                    ...
                    <Progresss :proge="Number(item.moneycount/item.target_amount*100).toFixed(1)" style="margin:5px 0;" v-if="Number(Number(item.demand_type))!==1"></Progresss>
  ...
  export default {
    ...
    created() {
       if(this.hotsearchList.length === 0){
        ...
        // 从老系统进入不调用getAPPdemand接口 fromOddsystem =1是来自老系统，0不是
